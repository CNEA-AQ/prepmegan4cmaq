...
echo "   $landtype_file -> landtype.nc"; gdalwarp -q -overwrite -s_srs "$srsInp" -t_srs "$srsOut" -te $xmin $ymin $xmax $ymax -tr $dx $dy -r mode -f "NetCDF"  $landtype_file ./tmp_grids/landtype.nc 
